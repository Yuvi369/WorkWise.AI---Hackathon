...
def generate_html_report(results: List[Dict], output_file: str = r"D:\ww_github\WorkWise.AI---Hackathon\workwise_AI\workwise\camel_ai\tools_camel\reports_exec\policy_agent_report.html"):
